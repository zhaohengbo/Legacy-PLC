...
//      | 12 Jul 2002 | E.O. | Modified RAM cmd file for flash.
//      | 18 Jul 2002 | E.O. | Created sections for trace buffer, and build info
//      | 07 Aug 2002 | M.H. | Rename McbspaRegsFile -> McbspRegsFile
//		| 07 Feb 2003 | M.H. | Modified map to make space for RAMSFUNCS in flash/RAM.
//      | 07 Oct 2004 | M.H. | Reconcile with RAM version. 
//      |             |      | Shrunk OTP from 2k to 1k to match documentation.
// -----|-------------|------|-----------------------------------------------
//###########################################################################
*/
...
PAGE 0 : 			/* ----- PROGRAM ----- */
	...
	/* set flash program length equal to RAM used in DEBUG    */
	/* starting location within 32K of reset vector at 3f7ff6 */
...
/*	RAMM0B			: origin = 0x000100, length = 0x000300 */
	...
	DRAML0    		: origin = 0x8000, length = 0x001000   
	DRAML1     		: origin = 0x9000, length = 0x001000	
}
...
SECTIONS
{
   ...
   .reset     		: > FLASHA,     	PAGE = 0	 /* Not sure why we need this */
   .text      		: > FLASHA,      	PAGE = 0
   .cinit     		: > FLASHA,      	PAGE = 0
   .flashreset 		: > FLASHRESET, 	PAGE = 0
   ramfuncs    		: LOAD > FLASHB, RUN > PRAMH0, PAGE = 0

   .const      		: > FLASHA,			PAGE = 0 	/* Put this is different section than fir_databuff to speed up FIR*/
