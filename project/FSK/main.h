...
//	#define MIPS		(120)
//	asm("MIPS	.set	120"); 
	#define DSP_FREQ    100000000L		// 100 MHz 2808 eZdsp board
//	#define	DSP_FREQ	150000000L		// 30  MHz oscillator /2 * 10 = 150 MHz
	#define MIPS		(100)			// F2808 MIPS
//	#define MIPS		(150)
//	asm("MIPS	.set	150"); 
	asm("MIPS	.set	100");			// F2808 MIPS
...
// Added by arefeen on 962205 *** starts here *****
	// ----- Set up T1PR -----
	...
	#define RX_Sampling	(TX_FREQ_m - 2*Fbit*1000) // System sampling rate 60.42 kHz
...
// Added by Arefeen on 062205  *** ends here ****
...
#define	PLC_RX_GOOD_LED	 GpioDataRegs.GPADAT.bit.GPIO20     // Green LED - Good PLC message received 
#define PLC_RX_BUSY_LED	 GpioDataRegs.GPADAT.bit.GPIO21		// Yellow LED - PLC message receive in progress
#define PLC_TX_LED  	 GpioDataRegs.GPADAT.bit.GPIO23		// Red LED - PLC transmit message in progress
#define TX_BIAS_EN       GpioDataRegs.GPADAT.bit.GPIO13		// Line Drive enable.
...
#define	INPUT_B8		(GpioDataRegs.GPADAT.bit.GPIO27^1)
//#define INPUT_B9		(GpioDataRegs.GPBDAT.bit.GPIOB9^1)
#define INPUT_B9		(GpioDataRegs.GPADAT.bit.GPIO6^1)
//#define INPUT_B10		(GpioDataRegs.GPBDAT.bit.GPIOB10^1)
#define INPUT_B10		(GpioDataRegs.GPADAT.bit.GPIO15^1)
//#define INPUT_B11		(GpioDataRegs.GPBDAT.bit.GPIOB11^1)
#define	INPUT_B11		(GpioDataRegs.GPADAT.bit.GPIO7^1)
...
#define UART_RTS 		GpioDataRegs.GPADAT.bit.GPIO16
...
//==========================================================================================
// Tx & Rx counter constants **** 070605 *******
//==========================================================================================
#define ADCINT_COUNT_MAX  	21	// rollover count for global variable ADCIntCount
//#define ADCINT_COUNT_MAX  	42	// rollover count for global variable ADCIntCount 072705
...
extern u16  ADCIntCountDelay;				// Index for delayed sample - Arefeen added on 062705
extern u16	uCmd_EchoAck;					// toggle this var between BER achnowledge packets

extern s16	demod;							// accumulator for receiver FIR
extern s16		demodBuf[ADCINT_COUNT_MAX]; // receive FIR buffer
