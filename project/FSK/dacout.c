...
//==========================================================================================
  // /* Taking DAC outputs out from the code **** arefeen 072405 *******
...
//arefeen		EvbRegs.ACTRB.all = (EvbRegs.ACTRB.all & ~0x000F) | 0x0001 ;	// PWM7= Active Lo, PWM8 = 0
				//???EvbRegs.ACTRB.bit.CMP7ACT = 0x1;		// PWM7 = Active Lo
				//???EvbRegs.ACTRB.bit.CMP8ACT = 0x0;		// PWM8 = 0
//				EvbRegs.CMPR4 = qOutVal>>(14-DAC_SIZE);
//arefeen		EvbRegs.CMPR4 = qDACVal;
				
			}
			else
			{
				// ACTRB = (ACTRB & ~0x000F) | 0x0004 ;	// PWM7= 0 , PWM8 = Active Lo
//arefeen		EvbRegs.ACTRB.all = (EvbRegs.ACTRB.all & ~0x000F) | 0x0004 ;	// PWM7= 0 , PWM8 = Active Lo
...
//arefeen		EvbRegs.ACTRB.all = (EvbRegs.ACTRB.all & ~0x00F0) | 0x0020 ;	// PWM9= Active Hi, PWM10 = 0
...
//				EvbRegs.CMPR5 = (1<<DAC_SIZE)-qDACVal;		// Send (1.0-val)
				EPwm6Regs.CMPA = (1<<DAC_SIZE)-qDACVal;		// Send (1.0-val)
				
			}
			else
			{
				// ACTRB = (ACTRB & ~0x00F0) | 0x0080 ;		// PWM9= 0, PWM10 = Active Hi
//arefeen		EvbRegs.ACTRB.all = (EvbRegs.ACTRB.all & ~0x00F0) | 0x0080 ;	// PWM9= 0, PWM10 = Active Hi
...
//arefeen		EvaRegs.ACTRA.all = (EvaRegs.ACTRA.all & ~0x000F) | 0x0001; 	// PWM1= Active Lo, PWM2 = 0
...
//arefeen		EvaRegs.CMPR1 = qDACVal;						// Send + value
			}
			else
			{
				// ACTRA = (ACTRA & ~0x000F) | 0x0004 ;	// PWM1= 0 , PWM2 = Active Lo
//arefeen		EvaRegs.ACTRA.all = (EvaRegs.ACTRA.all & ~0x000F) | 0x0004 ;	// PWM1= 0 , PWM2 = Active Lo
...
//arefeen		EvaRegs.ACTRA.all = (EvaRegs.ACTRA.all & ~0x00F0) | 0x0020 ;	// PWM3= Active Hi, PWM4 = 0
...
//arefeen				EvaRegs.CMPR2 = (1<<DAC_SIZE)-qDACVal;			// Send (1.0-val)
			}	
			else
			{
				// ACTRA = (ACTRA & ~0x00F0) | 0x0080 ;		// PWM3= 0, PWM4 = Active Hi
//arefeen   	EvaRegs.ACTRA.all = (EvaRegs.ACTRA.all & ~0x00F0) | 0x0080 ;	// PWM3= 0, PWM4 = Active Hi
