...
PAGE 1 : 			/* ----- DATA ----- */
	...
	/* SARAM */     
	DRAML0A    		: origin = 0x8000, length = 0x000040   /* arefeen */
	/*DRAML0     		: origin = 0x8040, length = 0x0009C0	*/
	/*DRAML1     		: origin = 0x9000, length = 0x001000	*/

/*	DRAML0    		: origin = 0x8000, length = 0x000400   */ /*arefeen */
	DRAML0    		: origin = 0x8040, length = 0x000500  
/*	DRAML1     		: origin = 0x8400, length = 0x001C00	*/ /*arefeen */
	DRAML1     		: origin = 0x8540, length = 0x001C00
}
