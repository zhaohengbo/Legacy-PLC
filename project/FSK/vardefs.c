...
u16		ADCIntCountDelay;		// Index for delayed sample - Arefeen added on 062705
...
s16		demodBuf[ADCINT_COUNT_MAX]; 	// receive FIR buffer
s16		demod;							// accumulator for receiver FIR
